<template>
  <div class="doc-content" id="scrollspy-nested" style="position:relative; height:720px; overflow-y:auto">
    <h2 class="title" id="item-2" >구성요소</h2>

    <h3 class="title-sm" id="item-2-1" >1. 뱃지(Badge)</h3>
    <div class="text mb-3">
    ...
    <h3 class="title-sm com-pt" id="item-2-2">2. 경로(Breadcrumb)</h3>
    ...
    <h3 class="title-sm com-pt" id="item-2-3">3. 단계(Step)</h3>
    <div class="text mb-3">
    ...
    <h3 class="title-sm com-pt" id="item-2-4">4. 슬라이드(carousel)</h3>
    <div class="text mb-3">
      <span>웹 사이트에서 이미지를 순환하여 보여줄 경우 사용한다.<br /> 이미지는 10개 이하를 사용한다.<br />좌/우 컨트롤과 함께 표시기를 함께 사용할 수 있다.(표시기를 눌렀을 경우 해당이미지 표출)</span>
    </div>
    <div class="text mb-5">
      <div>
        <b-carousel
    ...
    <h3 class="title-sm com-pt" id="item-2-5">5. 버튼(Button)</h3>
    <div class="text mb-3">
      다양한 크기, 스타일을 지원한다.
    </div>
    <div class="text">
    ...
    <h3 class="title-sm com-pt" id="item-2-6">6. 카드(Cards)</h3>
    <div class="text mb-3">
      <span>동일한 구성의 컨텐츠를 반복해서 보여줄 경우 카드를 사용하며, 이미지와 텍스트로 구성된다.<br />일반적으로 타이틀, 내용, 버튼으로 구성되며, 내용에 따라 버튼은 생략될 수 있다.</span>
    </div>
    <div class="text mb-5">
      ...
      <div class="mb-5">
        <div class="card com-card-style01">
          <p class="card-text-top com-card-text01">Image</p>
          <div class="card-body">
            <p class="card-title">Title</p>
            <p class="card-text">Adobe사에서 제공하는 무료 UI Kit<br />
              종류별로 사이트를 관리하기에 좋은 디자인입니다.<br />
              웹사이트 버전과 모바일 버전으로 나뉘어서 작업 할 수 있습니다.</p>
            <button class="btn btn-lg btn-primary com-btn-width">BUTTON</button>
          </div>
        </div>
      </div>
      ...
      <div>
        <div>
          <div class="card com-card-style02">
            <p class="card-text-top com-card-text02">Image</p>
            <div class="card-body">
              <p class="card-title">Title</p>
            </div>
          </div>
    ...
    <h3 class="title-sm com-pt" id="item-2-7">7. 폼(Forms)</h3>
    <div class="text mb-3">
    ...
    <div class="text mb-5">
      ...
      <form class="pl-3 mb-5">
        ...
        <div class="form-group mb-4">
          <input type="text" class="form-control com-input-width" title="example" placeholder="Normal">
        </div>
        <div class="mb-3 font-weight-bold">Disabled</div>
        <div class="form-group mb-4">
          <input type="text" class="form-control com-input-width" title="example" placeholder="Disabled" disabled>
        </div>
        <div class="mb-3 font-weight-bold">Read only</div>
        <div class="form-group mb-4">
          <input class="form-control mb-2 com-input-width" type="text" title="example" placeholder="read-only" readonly>
        </div>
        <div class="mb-3 font-weight-bold">Size</div>
        <div class="form-group">
          <input class="form-control form-control-sm mb-2 com-input-width" title="example" type="text" placeholder="Small">
          <input class="form-control com-input-width" type="text" title="example" placeholder="Medium">
        </div>
      </form>
      ...
      <div class="pl-3 mb-4 com-input-width">
      ...
      <div class="input-group pl-3 mb-3 com-input-width">
      ...
      <div class="pl-3 mb-5 com-input-width">
        <select class="custom-select" title="Text">
      ...
      <div class="pl-3 mb-3 font-weight-bold">Normal</div>
      <div class="input-group m-3 mb-4 com-input-width">
      ...
      <div class="pl-3 mb-3 font-weight-bold">Size</div>
      <div class="input-group m-3 com-input-width">
      ...
      <div class="input-group m-3 mb-5 com-input-width">
        <div class="custom-file">
      ...
      <form class="pl-3 mb-5">
        <div class="mb-3 font-weight-bold">Normal</div>
        <div class="input-group mb-4 com-input-width">
          <input class="form-control" type="search" placeholder="Search" aria-label="Search">
          <button class="btn btn-outline-light btn-search" type="submit"><i class="fas fa-search"></i></button>
        </div>
        <div class="mb-3 font-weight-bold">Disabled</div>
        <div class="input-group mb-4 com-input-width">
          <input class="form-control" type="search" placeholder="Search" aria-label="Search" disabled>
          <button class="btn btn-outline-light btn-search disabled" type="submit"><i class="fas fa-search"></i></button>
        </div>
        <div class="mb-3 font-weight-bold">Size</div>
        <div class="input-group mb-3 com-input-width">
          <input class="form-control form-control-sm" type="search" placeholder="Search" aria-label="Search">
          <button class="btn btn-outline-light btn-search btn-search-sm" type="submit"><i class="fas fa-search"></i>
          </button>
        </div>
        <div class="input-group mb-5 com-input-width">
          <input class="form-control" type="search" placeholder="Search" aria-label="Search">
          <button class="btn btn-outline-light btn-search" type="submit"><i class="fas fa-search"></i></button>
        </div>
      </form>
      ...
      <form class="pl-3 mb-5">
        <div class="form-group com-input-width mb-5">
          <input type="text" class="form-control is-invalid com-input-width" placeholder="Text" title="example" required>
          <div class="invalid-feedback">
            Text
          </div>
        </div>
        <div class="form-group com-input-width">
          <input type="text" class="form-control is-invalid com-input-width" placeholder="Text" title="example" required>
          <div class="invalid-feedback">
    ...
    <h3 class="title-sm com-pt" id="item-2-8">8. 페이지네이션(Pagination)</h3>
    <div class="text mb-3">
      <span>리스트가 많아 세로 스크롤이 길어질 경우 페이지로 구분하여 나타낼 경우 사용한다. <br />버튼 및 숫자 사이즈는 30px X 30px이며, 간격은 10px이다.<br />페이지 넘버가 길어질 경우(3자리) 숫자 좌/우 마진 5px 만큼 사이즈 늘어난다.</span>
    </div>
    <div class="text mb-5">
    ...
    <h3 class="title-sm com-pt" id="item-2-9">9. 탭(Tab)</h3>
    <div class="text mb-3">
      <span>화면이동 없이 내용을 바꿀 때 사용한다. <br />SNB와 같이 사용하여 SNB 메뉴를 눌렀을 때 메뉴가 탭으로 쌓인다.</span>
    </div>
    <div class="text mb-5">
      ...
      <div class="pl-3 mb-5 ">
        <b-tabs content-class="mt-3" >
          <b-tab title="Home" active><p>Home</p></b-tab>
          <b-tab title="Profile"><p>Profile</p></b-tab>
          <b-tab title="Contact"><p>Contact</p></b-tab>
        </b-tabs>
      </div>
      <div class="pl-3 mb-5">
    ...
    <h3 class="title-sm com-pt" id="item-2-10">10. 테이블(Table)</h3>
    <div class="text mb-3">
    ...
    <h3 class="title-sm com-pt" id="item-2-11">11. 사이드 네비게이션 바(SNB)</h3>
    <div class="text mb-3">
      <span>웹사이트 서브 화면에서 Depth 이동을 할 때 사용한다.<br />메인화면에서 메뉴를 구성 할 때 사용한다.</span>
    </div>
    <div class="text mb-5">
      ...
      <div class="row pl-3 mb-5">
        <div class="col-3">
          <div class="nav flex-column nav-pills nav-pills-light" id="v-pills-tab2" role="tablist" aria-orientation="vertical">
            <a class="nav-link active" id="v-pills-home-tab2" data-toggle="pill" href="#v-pills-home2" role="tab" aria-controls="v-pills-home" aria-selected="true"><i class="fas fa-circle"></i>Home</a>
            <a class="nav-link" id="v-pills-profile-tab2" data-toggle="pill" href="#v-pills-profile2" role="tab" aria-controls="v-pills-profile" aria-selected="false"><i class="fas fa-circle"></i>Profile</a>
            <a class="nav-link" id="v-pills-messages-tab2" data-toggle="pill" href="#v-pills-messages2" role="tab" aria-controls="v-pills-messages" aria-selected="false"><i class="fas fa-circle"></i>Messages</a>
            <a class="nav-link" id="v-pills-settings-tab2" data-toggle="pill" href="#v-pills-settings2" role="tab" aria-controls="v-pills-settings" aria-selected="false"><i class="fas fa-circle"></i>Settings</a>
          </div>
        </div>
        <div class="col-8">
          <div class="tab-content" id="v-pills-tabContent2">
            <div class="tab-pane fade show active com-tab-style03" id="v-pills-home2" role="tabpanel" aria-labelledby="v-pills-home-tab2">Home
            </div>
            <div class="tab-pane fade com-tab-style03" id="v-pills-profile2" role="tabpanel" aria-labelledby="v-pills-profile-tab2">
              Profile
            </div>
            <div class="tab-pane fade com-tab-style03" id="v-pills-messages2" role="tabpanel" aria-labelledby="v-pills-messages-tab2">
              Messages
            </div>
            <div class="tab-pane fade com-tab-style03" id="v-pills-settings2" role="tabpanel" aria-labelledby="v-pills-settings-tab2">
              Settings
            </div>
          </div>
        </div>
      ...
      <div class="row pl-3 mb-3">
        <div class="col-3">
          <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
            <a class="nav-link active" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-home" role="tab" aria-controls="v-pills-home" aria-selected="true">Home<i class="fas fa-angle-right"></i></a>
            <a class="nav-link" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false">Profile<i class="fas fa-angle-right"></i></a>
            <a class="nav-link" id="v-pills-messages-tab" data-toggle="pill" href="#v-pills-messages" role="tab" aria-controls="v-pills-messages" aria-selected="false">Messages<i class="fas fa-angle-right"></i></a>
            <a class="nav-link" id="v-pills-settings-tab" data-toggle="pill" href="#v-pills-settings" role="tab" aria-controls="v-pills-settings" aria-selected="false">Settings<i class="fas fa-angle-right"></i></a>
          </div>
        </div>
        <div class="col-8">
          <div class="tab-content" id="v-pills-tabContent">
            <div class="tab-pane fade show active com-tab-style03" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
              Home
            </div>
            <div class="tab-pane fade com-tab-style03" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
              Profile
            </div>
            <div class="tab-pane fade com-tab-style03" id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab">
              Messages
            </div>
            <div class="tab-pane fade com-tab-style03" id="v-pills-settings" role="tabpanel" aria-labelledby="v-pills-settings-tab">
              Settings
            </div>
          </div>
        </div>
    ...
    <h3 class="title-sm com-pt" id="item-2-12">12. 네비게이션 바(Navigation Bars)</h3>
    <div class="text mb-3">
    ...
    <h3 class="title-sm com-pt" id="modal">13. 모달(Modal)</h3>
    <div class="text mb-3">
          ...
          <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <button type="button" class="btn btn-lg btn-outline-secondary com-modal-btn" data-dismiss="modal">
                  Close
                </button>
                <button type="button" class="btn btn-lg btn-primary com-modal-btn">Save changes</button>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel2" aria-hidden="true">
          <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <button type="button" class="btn btn-lg btn-primary btn-block">Save changes
                </button>
              </div>
            </div>
          </div>
